...
void tick_camera();
extern float screen_zoom, screen_center_x, screen_center_y, fuel_amt;
extern int tot_altitude;
void reset_screen();
...
extern const color_t COLOR_VOILET;
...
extern const color_t COLOR_PBLACK;
extern const color_t COLOR_OCEAN;
extern const color_t COLOR_PRED;
extern const color_t COLOR_MAIN;
extern const color_t COLOR_MOUNT;
extern const color_t COLOR_PYELLOW;
